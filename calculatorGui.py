...
# Naming our GUI 
calculatorGui.title("MY CALCULATOR")
...
# All functions used in GUI  
# x² and x³ working functions
...
#-------------------------------------------------
# Calculation process of all number and operations except square & cube
